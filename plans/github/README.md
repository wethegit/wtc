...
- [6.4 Local Clone + WTC Project Bootstrap](6.4-local-clone-and-wtc-project-bootstrap.md): clone the repo and write `.wtc.yaml` into it with project links and Teamwork project ID.
