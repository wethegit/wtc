...
Timer overview, task timer indicators, start/pause/delete actions, submit/complete-to-timelog, timesheet access, and timer conflict confirmations. Refactored from local-only (`teamwork-local-timers.json`) to Teamwork native timer API (`GET/POST /projects/api/v3/me/timers.json`, `PUT /projects/api/v3/me/timers/{timerId}/pause.json`, `PUT /projects/api/v3/me/timers/{timerId}/resume.json`, `PUT /projects/api/v3/me/timers/{timerId}/complete.json`, `DELETE /projects/api/v3/me/timers/{timerId}.json`).
